...
First narrow down the specific programming language the bootcamp will be interviewing in. For Hack Reactor, it’s JavaScript, for App Academy, it’s Ruby. Learn the basics first using free online resources and try to figure out if programming is right for you. Both of these bootcamps have very rigorous application processes and have since monetized the ‘pre-bootcamp’ phase. Look into these prep courses or deep dive into the technical aspects of the language and practice implementing algorithms on algorithms on algorithms on algorithms.
...
Bonus: If you’re looking to enroll in [Dev Bootcamp](http://devbootcamp.com/), [Bitmaker Labs](https://bitmaker.co/), [Lighthouse Labs](https://www.lighthouselabs.ca/), or [HackerYou](http://hackeryou.com/), you’ll likely only need to know the basics. These bootcamps are tailored to a different market.
...
### __How do I guarantee my admission to the bootcamp?__

Practice implementing algorithms on algorithms on algorithms on algorithms. Practice after work if you’re working. Practice on weekends. Live and breathe code. Look into App Academy’s prep course. Last time I read, it guarantees you admission to the bootcamp of your choice.
...
Yes, Canadian bootcamps are significantly cheaper. They’re serving a completely different market. A post-secondary education in Canada costs about $5,000 a year. In the US, the average tuition a student pays through college/university is $42,419.

Note: These bootcamps vary in length and offer a different value proposition, so do our research. bootcamps are also not accredited education institutions, so you won’t be able to claim the tuition cost on your tax return, and you won’t be receiving a certificate. Your biggest weapon is your portfolio and your brain.
...
### __How do the coding bootcamps in Toronto compare with the bootcamps in San Francisco?__

I can’t speak for the Toronto bootcamps, but I want to say less rigorous. Ultimately though, you get what you make from your experience.
...
### __I am a Canadian citizen and I don’t have an American citizenship or a green card. How will I be able to attend the bootcamps in San Francisco? Will they offer a temporary student visa?__

Whenever you travel to the US, you get a 6-month travel visa by default. Bootcamps will never provide you with or help you obtain a travel/work visa.
...
### __How challenging is the bootcamp for someone with no coding experience whatsoever?__
...
### __When is the best time to start the bootcamp?__
...
For balance, meditate, exercise, enjoy some fresh air, and most importantly, remember to spend time with your friends and family.
...
Specifically for remote, there will be a lot of using Google Hangouts and Zoom. Then you pair program through a synced-up text editor. That's where your expectations should be at -- your experience will be highly collaborative. By far the most important aspect of any successful bootcamp.
...
[PrivateTable - AirBnB for private event spaces](http://www.privatetable.io/) -- search ‘San Francisco’.
...
### __Once I graduate from a US-based bootcamp, will I be able to apply for software engineering jobs outside of the US, like Canada, or will I only be able to apply in the city where I attended the bootcamp?__

Bootcamps don’t restrict where jobseekers look for work. You should let them know where you’re aiming to find work so that they can do their best to connect you to available opportunities. The better question is probably...
...
### __Which bootcamp has a better reputation?__
...
Here’s where you need to be mindful when you’re considering costs from a bootcamp perspective. You don't want to throw yourself in a cheaper, less known bootcamp and flush your money down the drain. I've heard many horror stories — search [‘Coding House Horror Stories’](https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=coding+house+horror+stories).
...
I would assume that Canadian bootcamps have some kind of reputation in Toronto, but can’t speak to if it’s positive or negative. I know that Bitmaker Labs offers some free introductory courses (which I’ve attended). They’re very basic, but maybe that’s what you need. If you’re interested in [HackerYou](http://hackeryou.com/), their founder, Heather Payne, is extremely friendly and willing to chat with candidates looking at bootcamps. Reach out to her directly, or I can connect you with her. Their community gave me the best impression, but I can only make the comment from a very high-level perspective.
...
* From what I know, Waterloo offers five year curriculums, but let’s be conservative and cut that down to four. Some people get scholarships and bursaries, and have an RESP (there are rarer education funding opportunities for bootcamps) which will knock this down a bit or a lot, depending who you are.
...
Are you looking to learn practical skills that you use in the work environment? Are you looking for the fastest way possible to find a job? Are you sure software is something you’re passionate about? Then you probably want to go with a bootcamp.
